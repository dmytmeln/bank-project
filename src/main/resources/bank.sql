...
CREATE TABLE IF NOT EXISTS bank_transactions (
    ...
    FOREIGN KEY (transaction_history_id) REFERENCES transaction_histories(transaction_history_id),
    PRIMARY KEY (bank_account_id, transaction_history_id)
);
/*
INSERT INTO users
VALUES (1, 'dmytro', 'melnyk', 'mdm281004', '380984035791', '2023-01-25 22:10:10');
...
INSERT INTO transaction_histories
VALUES (2, 'msg', 'transaction_type', 2000, '2023-02-25 20:10:10');
