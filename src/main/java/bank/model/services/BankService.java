...
import bank.model.repository.AccountTransactionRepository;
import bank.model.repository.BankAccountRepository;
...
public class BankService {
    ...
    @Autowired
    public BankService(@Qualifier("BankAccountRepositoryImpl") BankAccountRepository accountRepo,
                       @Qualifier("TransactionHistoryRepositoryImpl") TransactionHistoryRepository transactionRepo,
