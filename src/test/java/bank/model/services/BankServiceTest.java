...
import bank.model.repository.AccountTransactionRepositoryImpl;
import bank.model.repository.BankAccountRepositoryImpl;
import bank.model.repository.TransactionHistoryRepositoryImpl;
...
public class BankServiceTest {
    ...
    @Mock
    private BankAccountRepositoryImpl accountRepoMock;

    @Mock
    private TransactionHistoryRepositoryImpl transactionRepoMock;
    ...
    public void setup() throws AccountNotFound {
        ...
        when(accountRepoMock.findById(id)).thenReturn(bankAccount);
